...
from dto.graph.graph_dto import SimpleWorkflowRequest
...
class TestCreateSimpleWorkflow:
    ...
    def test_create_simple_workflow_success(self):
        ...
        mock_result = {
            ...
            "workflow": {
                ...
                "vertices": [
                    ...
                    {"id": 2, "type": "process", "properties": {"action": "test_action"}},
        ...
        with patch('routers.v1.graph.workflow_router.get_graph_service') as mock_get_service:
            ...
            mock_graph_service.create_simple_workflow.assert_called_once_with(
                ...
                self.test_workflow_description
            )
    ...
    def test_create_simple_workflow_service_error(self):
        ...
        with patch('routers.v1.graph.workflow_router.get_graph_service') as mock_get_service:
            mock_graph_service = AsyncMock(spec=GraphService)
            mock_graph_service.create_simple_workflow.side_effect = Exception("Database connection failed")
            mock_get_service.return_value = mock_graph_service
